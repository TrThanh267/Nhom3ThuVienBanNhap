...
namespace QuanLyThuVienNhom3.GUI.UC
{
    ...
    {
        private readonly QuanLyDocGia_BLL _quanLyDocGia_BLL;
        public UserControl_QuanLyDocGia()
        {
            _quanLyDocGia_BLL = new QuanLyDocGia_BLL();
            InitializeComponent();
            LoadDaTa();
        }
        ...
        private void Button_Luu_Click(object sender, EventArgs e)
        {
            ...
            if (isAdding == true)
            {
                ...
                {
                    MessageBox.Show("Tên độc giả phải từ 10 đến 50 ký tự!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    return;
                }
